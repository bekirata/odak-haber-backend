    ...
    while True:
        try:
            ...
            chat = LlmChat(
                ...
                session_id=f"global_summary_{uuid.uuid4()}",
                system_message="""Sen Türkçe haber özetleme uzmanısın. Verilen haberleri JSON formatında özetle.
...
Format: {"items": [{"index": 1, "title": "başlık", "summary": "özet"}], "overall": "genel değerlendirme"}"""
            ...
            user_message = UserMessage(
                text=f"Bu 15 haberi JSON formatında özetle:\n\n{news_text}"
            )
...
async def generate_summary(request: SummaryRequest):
    ...
    try:
        ...
        chat = LlmChat(
            ...
            system_message="""Sen Türkçe haber özetleme uzmanısın. 
